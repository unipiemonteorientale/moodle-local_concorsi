...
$string['idnumberlength'] = 'ID Number length';
$string['configidnumberlength'] = 'The length of user idnumbers, padded with zeros to fill the length';
...
$string['numberofusers'] = 'Number of users to be created';
$string['role'] = 'Role';
